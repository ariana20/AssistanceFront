            ...
            <div class="row grid-divider">
                ...
                <div class="der col-lg-6 col-xm col-md-12">
                    ...
                    <div style="margin-bottom:20px;text-align:left">
                        ...
                        <b-button v-on:click="verPdf=false;verCitas=false" style="background: #0097A7;border: 0px;width:40%;margin-left:5%">
                            Plan de Accion
                        </b-button><br><br>
                        ...
                        <b-button v-on:click="verPdf=true;verCitas=false" style="background: #0097A7;border: 0px;width:40%;margin-left:5%">
                            Historico de Notas
                        </b-button><br><br>
                        ...
                        <b-button v-on:click="verPdf=false;verCitas=true" style="background: #0097A7;border: 0px;width:40%;margin-left:5%">
                            Historico de Citas
                        </b-button>
                    </div>                
                </div>
