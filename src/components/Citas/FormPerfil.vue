            ...
            <div class="row grid-divider">
                ...
                <div class="der col-lg-6 col-xm col-md-12">
                    ...
                    <div style="margin-bottom:20px;text-align:left">
                        ...
                        <b-button v-on:click="$store.state.verPdf=true;$store.state.verCitas=false;$store.state.verPlan=false" style="background: #0097A7;border: 0px;width:40%;margin-left:5%">
                            Historico de Notas
                        </b-button><br><br>
