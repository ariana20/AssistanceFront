        ...
        <div style="width:100%; border-bottom:1px solid #bababa; height:1px;padding-top:15px; margin-bottom:15px;"></div>
            ...
            <div class="der col-lg-6 col-xm col-md-12">
                ...
                <div style="margin-bottom:20px;text-align:left">
                    ...
                    <b-button v-on:click="verPdf=false" style="background: #0097A7;border: 0px;width:40%;margin-left:5%">
                        Plan de Accion
                    </b-button><br><br>
                    ...
                    <b-button v-on:click="verPdf=true" style="background: #0097A7;border: 0px;width:40%;margin-left:5%">
                        Historico de Notas
                    </b-button><br><br>
