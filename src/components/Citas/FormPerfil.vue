        ...
        <div name="VisorPdf" v-if="this.$store.state.verPdf && usuario!=null ">
            <div class="container" style="width:100%">
                <div v-if="usuario.notas!=null && usuario.notas!=''">
                    <!-- {{usuario.notas}} -->
                    <embed class="toolb" :src="'https://tutoriaback.inf.pucp.edu.pe/usuarios/'+usuario.notas+'#toolbar=0&navpanes=0&scroll=0'" height="400vh" style="width:85%;overflow:auto"/>
                </div>
                <div v-else>
